...
<body>
    ...
    <table>
        ...
        <tr>
            <td>제목: <input type="text" name="title" value="${epboardVO.title}" ${isAuthor ? '' : 'readonly'} /></td>
        </tr>
        <tr>
            <td>내용: <textarea name="content" ${isAuthor ? '' : 'readonly'}>${epboardVO.content}</textarea></td>
        </tr>
        <tr>
            <td>
                <c:if test="${isAuthor}">
	...
	<table id="history">
		...
		<c:forEach var="history" items="${historyList}">
			<tr>
				...
				<td><fmt:formatDate value="${history.reg_date}"
